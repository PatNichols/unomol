...
{
public:
    UnRestrictedHartreeFock(Basis* b,const TwoElectronInts* x);
...
inline UnRestrictedHartreeFock::UnRestrictedHartreeFock(Basis* b,
...
inline UnRestrictedHartreeFock::~UnRestrictedHartreeFock()
{
    delete [] Wrka;
    delete [] sEvals;
    delete [] EvalsB;
...
inline void UnRestrictedHartreeFock::update()
{
    register int i;
    for (i=0;i<no2;++i)
    {
...
inline void UnRestrictedHartreeFock::dpm_update(const TwoElectronInts& xints)
{
    register int i;
    for (i=0;i<no2;++i)
    {
...
inline void UnRestrictedHartreeFock::findEnergy()
{
...
inline void UnRestrictedHartreeFock::formCmatrix(double* c)
{
    copy_trans(no,Wmat);
...
inline void UnRestrictedHartreeFock::formPmatrix(double* p,double *c,int noc)
{
    register int ij=0;
    for (register int i=0;i<no;++i)
    {
...
inline void UnRestrictedHartreeFock::PmatrixGuess()
{
...
inline void UnRestrictedHartreeFock::formXmatrix()
{
...
inline void UnRestrictedHartreeFock::FiniteFieldAnalysis()
{
...
inline double UnRestrictedHartreeFock::nuclear_repulsion_energy(int ncen,
        const Center* center)
{
    register double sum=0.0;
    double q1,q2,r12;
...
inline void UnRestrictedHartreeFock::findPolarizationPotential()
{
    double px,py,pz;
...
inline bool UnRestrictedHartreeFock::is_converged()
{
    switch (cflag)
    {
    case 0:
...
inline void UnRestrictedHartreeFock::final_output(double init_energy)
{
...
inline void UnRestrictedHartreeFock::OintsOutput()
{
...
inline void
UnRestrictedHartreeFock::scf_converger()
{
    register int i;
...
inline void UnRestrictedHartreeFock::PopulationAnalysis(FILE *out)
{
    const Center *center=basis.center_ptr();

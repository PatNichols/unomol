...
inline ostream& Shell::write_to_stream(ostream& os) const
{
...
inline istream& Shell::init_from_stream(istream& is)
{
    is>>npr;
    is>>lsh;
    is>>cen;
...
inline ostream& operator<<(ostream& os,const Shell& sh)
{
    return sh.write_to_stream(os);
}


inline istream& operator>>(istream& is,Shell& sh)
{

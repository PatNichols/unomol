...
class RestrictedHartreeFock
    {
    public:
        RestrictedHartreeFock(Basis* b,const TwoElectronInts* x);
...
inline RestrictedHartreeFock::RestrictedHartreeFock(Basis* b,
...
inline RestrictedHartreeFock::~RestrictedHartreeFock()
    {
    delete [] Wrka;
    delete [] sEvals;
    delete [] Evals;
...
inline void RestrictedHartreeFock::update()
    {
    register int i;
...
inline void RestrictedHartreeFock::dpm_update(const TwoElectronInts& xints)
    {
    register int i;
...
inline void RestrictedHartreeFock::findEnergy()
    {
...
inline void RestrictedHartreeFock::formCmatrix(double* c)
    {
    copy_trans(no,Wmat);
...
inline void RestrictedHartreeFock::formPmatrix(double* p,double *c,int noc)
    {
    register int ij=0;
    for (register int i=0; i<no; ++i)
        {
...
inline void RestrictedHartreeFock::PmatrixGuess()
    {
...
inline void RestrictedHartreeFock::formXmatrix()
    {
...
inline void RestrictedHartreeFock::FiniteFieldAnalysis()
    {
...
inline double RestrictedHartreeFock::nuclear_repulsion_energy(int ncen,
        const Center* center)
    {
    register double sum=0.0;
    double q1,q2,r12;
...
inline void RestrictedHartreeFock::findPolarizationPotential()
    {
    double px,py,pz;
...
inline bool RestrictedHartreeFock::is_converged()
    {
    switch (cflag)
        {
        case 0:
...
inline void RestrictedHartreeFock::final_output(double init_energy)
    {
...
inline void RestrictedHartreeFock::OintsOutput()
    {
...
inline void
RestrictedHartreeFock::scf_converger()
    {
    register int i;
...
inline void RestrictedHartreeFock::PopulationAnalysis(FILE *out)
    {
    const Center *center=basis.center_ptr();

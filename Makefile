...
MPI_FILES= Util.o SymmPack.o Rys.o Moments.o OneElectronInts.o FField.o TwoElectronInts.o GDPMInts.o UnomolMPI.o
...
mpilib:
	...
	$(MPICXX) $(CXXFLAGS) -DUNOMOL_MPI_ABI -c TwoElectronInts.cpp

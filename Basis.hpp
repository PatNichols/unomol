...
public:
    ...
    int number_of_electrons() const {
        return nelec;
    }
    int number_of_shells() const {
        return nshell;
    }
    int number_of_centers() const {
        return ncen;
    }
    int number_of_orbitals() const {
        return norb;
    }
    int total_number_of_shells() const {
        return tnshell;
    }
    int total_number_of_centers() const {
        return tncen;
    }
    int total_number_of_orbitals() const {
        return tnorb;
    }
    int maximum_iterations() const {
        return maxits;
    }
    int scf_flags(int i) const {
        return scf_flag[i];
    }
    int prt_flags(int i) const {
        return prt_flag[i];
    }
    int int_flags(int i) const {
        return int_flag[i];
    }
    const Shell* shell_ptr() const {
        return shells;
    }
    const Center* center_ptr() const {
        return centers;
    }
    const AuxFunctions* auxfun_ptr() const {
        return aux;
    }
    double scf_eps() const {
        return eps;
    }
    int skip_center() const {
        return skipcen;
    }
    void dpm_augment() {
        nshell=tnshell;
    ...
    int number_of_dpm_points() {
        return dpmgrid;
    }
    double FiniteFieldValue() {
        return ffield;
    }
    const double *transformation_matrix() const {
        return trans;
    }
    void find_com(double *trans)
    {
        int i,icen;
        const double *ri;
        double q[6];
